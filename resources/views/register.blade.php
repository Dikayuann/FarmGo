...
<div class="flex h-full w-full">
    ...
    <div class="w-full md:w-1/2 flex flex-col justify-center px-8 sm:px-12 lg:px-24 bg-white z-10 rounded-lg shadow-lg">
        ...
        <form action="{{ route('register.submit') }}" method="POST" class="space-y-5">
            ...
            <div>
                ...
                <input type="text" id="full_name" name="full_name" placeholder="Masukan Nama Lengkap"
                       class="w-full px-4 py-3 rounded-lg border @error('full_name') border-red-500 @else border-gray-300 @enderror focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 placeholder-gray-400 text-sm transition duration-300"
            ...
            <div>
                ...
                <input type="text" id="farm_name" name="farm_name" placeholder="Masukan Nama Peternakan"
                       class="w-full px-4 py-3 rounded-lg border @error('farm_name') border-red-500 @else border-gray-300 @enderror focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 placeholder-gray-400 text-sm transition duration-300"
                       value="{{ old('farm_name') }}">
                @error('farm_name')
                    <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                @enderror
            ...
            <div>
                ...
                <input type="email" id="email" name="email" placeholder="Masukan Email"
                       class="w-full px-4 py-3 rounded-lg border @error('email') border-red-500 @else border-gray-300 @enderror focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 placeholder-gray-400 text-sm transition duration-300"
            ...
            <div>
                ...
                <input type="tel" id="phone" name="phone" placeholder="Masukan Nomor Handphone"
                       class="w-full px-4 py-3 rounded-lg border @error('phone') border-red-500 @else border-gray-300 @enderror focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 placeholder-gray-400 text-sm transition duration-300"
                       value="{{ old('phone') }}">
                @error('phone')
                    <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                @enderror
            ...
            <div class="relative">
                ...
                <div class="relative">
                    <input type="password" id="password" name="password" placeholder="Masukan Password (min. 8 karakter)"
                           class="w-full px-4 py-3 rounded-lg border @error('password') border-red-500 @else border-gray-300 @enderror focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 placeholder-gray-400 text-sm transition duration-300" required>
        ...
        <!-- Google Login Button -->
        <a href="{{ route('auth.google') }}" class="w-full bg-[#2d2d2d] text-white font-medium py-3 rounded-lg hover:bg-black transition duration-300 flex items-center justify-center gap-3">
