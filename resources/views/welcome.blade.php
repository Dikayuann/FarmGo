...
<body
    ...
    <header class="w-full lg:max-w-4xl max-w-[335px] mb-12">
        <div class="flex items-center justify-between">
            <!-- Logo and Brand -->
            <div class="flex items-center gap-4">
                <img src="{{ asset('image/FarmGo.png') }}" alt="FarmGo Logo" class="h-16 w-auto">
                <div class="flex flex-col">
                    <h1 class="text-2xl font-bold text-[#1b1b18] dark:text-[#EDEDEC] tracking-tight">FarmGo</h1>
                    <p class="text-sm text-[#706f6c] dark:text-[#A1A09A]">Smart Farm Management System</p>
                </div>
            </div>
                ...
                <nav class="flex items-center gap-3">
                    @auth
                        <a href="{{ url('/dashboard') }}"
                            class="inline-block px-6 py-2.5 bg-emerald-600 hover:bg-emerald-700 text-white rounded-lg text-sm font-medium transition-colors shadow-sm">
                            Dashboard
                        </a>
                    @else
                        <a href="{{ route('login') }}"
                            class="inline-block px-5 py-2 dark:text-[#EDEDEC] text-[#1b1b18] border border-[#19140035] hover:border-emerald-600 dark:border-[#3E3E3A] dark:hover:border-emerald-500 rounded-lg text-sm font-medium transition-colors">
                            Log in
                        </a>
