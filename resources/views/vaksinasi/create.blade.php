...
@section('title', 'Tambah Vaksinasi - FarmGo')
...
<div>
    ...
    <div class="bg-white rounded-2xl shadow-lg border border-gray-100 overflow-hidden">
        ...
        <div class="bg-emerald-600 px-8 py-6">
            ...
            <p class="text-emerald-100 mt-1">Isi form di bawah untuk menambahkan data vaksinasi baru</p>
        </div>

        {{-- Form --}}
        <form method="POST" action="{{ route('vaksinasi.store') }}">
            @csrf
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <input type="date" id="tanggal_vaksin" name="tanggal_vaksin" required 
                                value="{{ old('tanggal_vaksin', now()->format('Y-m-d')) }}"
